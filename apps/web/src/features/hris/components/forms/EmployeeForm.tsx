...
const preprocessFormData = (data: Record<string, any>): Record<string, any> => {
...
const employeeSchema = z.object({
  // ID fields (optional for form use)
...
export default function EmployeeForm({
  ...
  const handleFormSubmit = (data: EmployeeFormData): void => {
  ...
  const handleFormSubmitWithoutFocus = (e: React.FormEvent<HTMLFormElement>): void => {
    e.preventDefault();
    (handleSubmit(handleFormSubmit) as any)(e);
  ...
  function FieldError({ error }: { error?: { message?: string } }): React.ReactElement | null {
