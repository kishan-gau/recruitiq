...
function RequestDataDisplay({ requestType, requestData, reason }: RequestDataDisplayProps) {
...
function ApprovalDetailModal({ approval, onClose, onApprove, onReject, loading }: ApprovalDetailModalProps) {
