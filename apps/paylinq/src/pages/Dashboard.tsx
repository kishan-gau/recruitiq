...
import { DashboardSummaryCard, PayrollTimeline } from '@/components/ui';
import type { TimelineRun } from '@/components/ui';
import { mockDashboardData } from '@/utils/mockData';
import { formatCurrency } from '@/utils/helpers';

export default function Dashboard() {
  const navigate = useNavigate();
  const { summary, recentActivity, pendingApprovals } = mockDashboardData;
