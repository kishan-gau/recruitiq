...
jest.mock('../../../repositories/CandidateRepository.ts');
...
describe('ApplicationService', () => {
  ...
  beforeEach(async () => {
    ...
    const { CandidateRepository } = await import('../../../repositories/CandidateRepository');
    mockOrganization = (await import('../../../models/Organization')).default;
